...
export default async function Page() {
  ...
  return (
    <Wrapper toc={[]} metadata={metadata} sourceCode={""} >
      ...
      <P>Enthusiast comes with a bunch of pre-built agents that cover many common use cases for back-office operations, such as enhancing product data, searching internal documentation, and processing business documents.</P><P>This curated library allows you to quickly deploy specialized AI solutions for automation and productivity without needing to build custom agents from scratch. Furthermore, these agents can be customized and extended by a developer to precisely adjust their behavior and integrate with your business workflows.</P>

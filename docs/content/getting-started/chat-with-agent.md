...
The enthusiast-starter package comes with a few example agents, that are pre-configured to execute different workflows. To learn more how to build custom agents, see the [customization](/docs/category/customization/) section of the documentation.
...
- [Learn more about data sets](/docs/synchronize/manage-data-sets)
- [See how to manage users](/docs/manage/manage-users)
- [Add custom tools for the AI agent](/docs/chat/add-custom-tools)

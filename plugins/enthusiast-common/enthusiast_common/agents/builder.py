...
from ..registry import BaseLanguageModelRegistry, BaseEmbeddingProviderRegistry
...
class AgentBuilder:
    ...
    def _build_injector(self, embeddings_registry: BaseEmbeddingProviderRegistry) -> BaseInjector | None:
        if not self._config.injector:
            return None
    ...
    def _build_llm_tools(self, default_llm: BaseLanguageModel, injector: BaseInjector) -> list[BaseLLMTool]:
        ...
        for tool_config in self._config.llm_tools:
            llm = default_llm
            data_set_id = tool_config.data_set_id or self._config.data_set_id
            if tool_config.llm:
                llm = tool_config.llm
            tools.append(
    ...
    def _build_product_retriever(self) -> BaseProductRetriever:
        ...
        return self._config.retrievers.product.retriever_class(
            ...
            data_set_repo=self._config.repositories.data_set,
            product_repo=self._config.repositories.product,
    ...
    def _build_document_retriever(self, embeddings_registry: BaseEmbeddingProviderRegistry) -> BaseDocumentRetriever:
        return self._config.retrievers.document.retriever_class(
            ...
            document_chunk_repo=self._config.repositories.document_chunk,
        )

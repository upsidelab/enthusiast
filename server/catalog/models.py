...
class Product(models.Model):
    ...
    properties_deprecated = models.CharField(max_length=65535, blank=True, null=True)
    categories_deprecated = models.CharField(max_length=65535, blank=True, null=True)

...
urlpatterns = [
    ...
    path("api/data_sets/<int:data_set_id>/sync",
    ...
    path('api/data_sets/<int:data_set_id>/document_sources', views.DataSetDocumentSourceListView.as_view(),
         name='data_set_document_source_list'),
    path('api/data_sets/<int:data_set_id>/document_sources/<int:document_source_id>',
         views.DataSetDocumentSourceView.as_view(),
         name='data_set_document_source_details'),
    path('api/document_sources/sync',
         views.SyncAllDocumentSourcesView.as_view(),
         name='all_document_sources_sync'),
    path('api/data_sets/<int:data_set_id>/document_sources/sync',
    ...
    path('api/data_sets/<int:data_set_id>/sync_schedule', views.SyncScheduleView.as_view(), name='sync_schedule'),

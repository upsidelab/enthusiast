...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ecl', '0013_question_prompt_message'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='conversation',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='answer_document', to='ecl.conversation'),
        ),
        migrations.AlterField(
            model_name='answerdocument',
            name='document',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='answer_document', to='ecl.document'),
        ),
        migrations.AlterField(
            model_name='answerdocument',
            name='document_embedding',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='answer_document', to='ecl.documentembedding'),
        ),
        migrations.AlterField(
            model_name='answerdocument',
            name='question',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='answer_document', to='ecl.question'),
        ),
        migrations.AlterField(
            model_name='conversation',
            name='model',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='conversation', to='ecl.embeddingmodel'),
        ),
        migrations.AlterField(
            model_name='document',
            name='data_set',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='document', to='ecl.dataset'),
        ),
        migrations.AlterField(
            model_name='documentembedding',
            name='document',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='embedding', to='ecl.document'),
        ),
        migrations.AlterField(
            model_name='documentembedding',
            name='model',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='ecl.embeddingmodel'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='product',
            name='company_code',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='ecl.dataset'),
        ),
        migrations.AlterField(
            model_name='question',
            name='conversation',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='question', to='ecl.conversation'),
        ),
        ...
        migrations.AddField(
            model_name='dataset',
            name='owner',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='data_set', to='ecl.owner'),
        ),
    ]
